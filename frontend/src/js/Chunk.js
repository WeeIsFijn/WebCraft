...
export class Chunk{
	...
	getBlockArrayElement(x,y,z){
		if( x<0 || y<0 || z<0 || x>this.blockArraySize || y>this.blockArraySize || z>this.blockArraySize){
	...
	addVertexNormal(vertNormal, x, y, z){
		return vertNormal.concat(x, y, z).concat(x, y, z).concat(x, y, z);
	}


	initBuffers(){
		this.generateBlockArray(3, 0);
		var SOLIDLIMIT = 0.5;
